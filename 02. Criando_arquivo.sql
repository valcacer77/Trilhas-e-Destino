...
data_reserva DATE,
status VARCHAR(20),
FOREIGN KEY (id_cliente) REFERENCES Reservas(id_reserva)
);
...
VALUES
('Joao', 'Silva', 'joao.silva@example.com', '123456789', 'Rua 1, 123'),
...
('Hugo', 'Araujo', 'hugo.araujo@example.com', '666777888', 'Rua 10, 890');
